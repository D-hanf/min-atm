...
const HalamanTema = () => {
  ...
  const colorSchemes = [
    {
      id: COLOR_SCHEMES.DEFAULT,
      name: 'Default',
      className: isDark ? 'bg-gray-700' : 'bg-gray-100'
    },
    { id: COLOR_SCHEMES.BLUE, name: 'Sky Blue', className: isDark ? 'bg-sky-800' : 'bg-sky-100' },
    {
      id: COLOR_SCHEMES.GREEN,
      name: 'Mint',
      className: isDark ? 'bg-emerald-800' : 'bg-emerald-100'
    },
    {
      id: COLOR_SCHEMES.PURPLE,
      name: 'Lavender',
      className: isDark ? 'bg-violet-800' : 'bg-violet-100'
    },
    {
      id: COLOR_SCHEMES.YELLOW,
      name: 'Cream',
      className: isDark ? 'bg-amber-800' : 'bg-amber-100'
    },
    {
      id: COLOR_SCHEMES.ORANGE,
      name: 'Peach',
      className: isDark ? 'bg-orange-800' : 'bg-orange-100'
    },
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className={`text-2xl font-bold mb-8 ${isDark ? 'text-white' : 'text-gray-800'}`}>
        Pengaturan Tema
      </h1>
