...
const FinancialSummaryCards = ({ financialSummary, formatRupiah, userRole }) => {
  ...
  return (
    <div className={`grid gap-4 mb-6 grid-cols-5`}>
      <div className={`${isDark ? 'bg-gray-800' : 'bg-white'} shadow rounded-lg p-4 flex items-center justify-between transition-transform hover:shadow-lg hover:-translate-y-1`}>
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className={`font-bold ${isDark ? 'text-white' : ''}`}>{formatRupiah(financialSummary.cashWithdrawal)}</p>
          </div>
        </div>
      </div>
      ...
      <div className={`${isDark ? 'bg-gray-800' : 'bg-white'} shadow rounded-lg p-4 flex items-center justify-between transition-transform hover:shadow-lg hover:-translate-y-1`}>
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className={`font-bold ${isDark ? 'text-white' : ''}`}>{formatRupiah(financialSummary.transfer)}</p>
          </div>
        </div>
      </div>
      ...
      <div className={`${isDark ? 'bg-gray-800' : 'bg-white'} shadow rounded-lg p-4 flex items-center justify-between transition-transform hover:shadow-lg hover:-translate-y-1`}>
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className={`font-bold ${isDark ? 'text-white' : ''}`}>{formatRupiah(financialSummary.bankAdmin)}</p>
          </div>
        </div>
      </div>
      ...
      <div className={`${isDark ? 'bg-gray-800' : 'bg-white'} shadow rounded-lg p-4 flex items-center justify-between transition-transform hover:shadow-lg hover:-translate-y-1`}>
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className={`font-bold ${isDark ? 'text-white' : ''}`}>{formatRupiah(financialSummary.profit)}</p>
          </div>
        </div>
      </div>
      ...
      <div className={`${isDark ? 'bg-gray-800' : 'bg-white'} shadow rounded-lg p-4 flex items-center justify-between transition-transform hover:shadow-lg hover:-translate-y-1`}>
        <div className="flex items-center">
          ...
          <div>
            ...
            <p className={`font-bold ${isDark ? 'text-white' : ''}`}>{formatRupiah(financialSummary.modePulsa)}</p>
          </div>
        </div>
      </div>
    </div>
